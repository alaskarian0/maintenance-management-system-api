...
export async function seedCore(prisma: PrismaClient) {
  ...
  await prisma.link.createMany({
    data: [
      ...
      { name: 'المؤتمن', url: 'http://10.10.10.181:22234/' },
      ...
      { name: 'الرواتب', url: 'http://10.10.10.181:22236/', apiUrl: 'http://10.10.10.181:22235/' },
      { name: 'المشتريات', url: 'http://10.10.10.181:22262/', apiUrl: 'http://10.10.10.181:22261/' },
      { name: 'السكرتارية', url: 'http://10.10.10.181:22272/' },
      { name: 'مركز الأدوات', url: 'http://10.10.10.181:22292/' },
      { name: 'التطوع', url: 'http://10.10.10.181:22242/', apiUrl: 'http://10.10.10.181:22241/' },
